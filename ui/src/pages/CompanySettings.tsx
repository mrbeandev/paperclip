...
const PERMISSION_GROUPS: Array<{ label: string; keys: string[] }> = [
  ...
  { label: "Issues & Tasks", keys: ["issues:create", "tasks:assign", "tasks:assign_peers", "tasks:assign_scope"] },
...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  "tasks:assign_peers": "Assign tasks to peer agents/users (same level)",
